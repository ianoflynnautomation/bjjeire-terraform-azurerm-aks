...
resource_group_name        = "rg-acme-prod-weu-01"
location                   = "westeurope"
...
aks_cluster_name                                         = "aks-acme-prod-weu-01"
aks_sku_tier                                             = "Free"
...
aks_rbac_aad_admin_group_object_ids                      = ["REPLACE_WITH_ADMIN_GROUP_OID"]
aks_auto_scaling_enabled                                 = true
aks_agents_min_count                                     = 2
...
aks_api_server_authorized_ip_ranges                      = ["203.0.113.0/24"] # replace with admin/VPN/NAT CIDRs
...
kv_name                                                  = "kv-acme-prod-weu-01"
kv_sku_name                                              = "standard"
kv_purge_protection_enabled                              = true
kv_soft_delete_retention_days                            = 90
vnet_name                                                = "vnet-acme-prod-weu-01"
vnet_address_space                                       = ["10.40.0.0/16"]
storage_images_account_name                              = "stacmeimagesweuprod01"
storage_images_replication_type                          = "LRS"
storage_images_cors_origins                              = ["https://example.com", "https://www.example.com"]
budget_amount                                            = 400
